...
The is a README template for your project. Please start by renaming this to
README.md and deleting everything up to and including the "template begins here"
comment in this markdown file.

Replace [TODO: PROJECTNAME] with the name of your project.

<!-- template begins here-->

# Welcome to the project template essential community project!
...
Please ensure that you also read the [complete code of conduct](CODE_OF_CONDUCT.md).
